...
package org.apache.skywalking.apm.plugin.threadpool;
...
public abstract class AbstractThreadingPoolInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    private static final String[] ignore_package = {"org.jboss", "com.alibaba", "org.apache", "io.netty", "okhttp3", "okio", "com.xxl"};
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        ...
        //  submit RunnableFuture 那边已经增强  submit最终会调用execute
        if (argument instanceof RunnableFuture || argument instanceof ForkJoinTask) {
            return;
        }
        //排除不增强的线程池
        String className = argument.getClass().getName();
        for (String s : ignore_package) {
